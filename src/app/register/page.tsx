...
import { User, Mail, Lock, Phone, Eye, EyeOff, ShoppingBag, Check } from 'lucide-react'
...
if (verifyData.verifyUrl) {
  setTimeout(() => {
    router.push(verifyData.verifyUrl)
  }, 1500)
} else {
  setTimeout(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1E3A5F] via-[#2d5a8f] to-[#1E3A5F] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200">Join us and start shopping</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start">
              <input
                type="checkbox"
                required
                className="w-4 h-4 text-[#F97316] border-gray-300 rounded focus:ring-[#F97316] mt-1"
              />
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link href="/login" className="text-[#F97316] hover:text-[#ea6a0f] font-semibold">
              Sign in
            </Link>
          </p>
        </div>
